...
extension QuickLoginSettingViewController: UITableViewDataSource {
  ...
  func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
    let cell = tableView.dequeueReusableCell(withIdentifier: "QuickLoginSettingTableViewCell") as! QuickLoginSettingTableViewCell
