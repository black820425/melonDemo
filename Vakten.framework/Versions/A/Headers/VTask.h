...
/*!
 @discussion A task is a simple data-carrying object with the following properties. Most strings in a VTask are for
 direct presentation in a user interface.
 Task objects are currently not serializable so the application must copy the properties into some data structure if it
 wishes to keep them after the application has terminated.
 */
